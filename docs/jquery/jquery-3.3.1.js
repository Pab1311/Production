  ...
  function adjustCSS(elem, prop, valueParts, tween) {
    ...
    if (initialInUnit && initialInUnit[3] !== unit) {
      ...
      while (maxIterations--) {
        ...
        if ((1 - scale) * (1 - (scale = currentValue() / initial || 0.5))
            <= 0) {
          maxIterations = 0;
        }
  ...
  jQuery.event = {
    ...
    handlers: function (event, handlers) {
      ...
      if (delegateCount &&
        ...
        for (; cur !== this; cur = cur.parentNode || this) {
          ...
          if (cur.nodeType === 1 && !(event.type === "click" && cur.disabled
              === true)) {
            matchedHandlers = [];
            matchedSelectors = {};
    ...
    special: {
      ...
      click: {
        ...
        trigger: function () {
          if (this.type === "checkbox" && this.click && nodeName(this,
              "input")) {
            this.click();
            return false;
          }
...
// Prefer a tbody over its parent table for containing new rows
  function manipulationTarget(elem, content) {
    if (nodeName(elem, "table") &&
        nodeName(content.nodeType !== 11 ? content : content.firstChild,
            "tr")) {
...
// Fix IE bugs, see support tests
  ...
  (function () {
    ...
    var pixelPositionVal, boxSizingReliableVal, scrollboxSizeVal,
        pixelBoxStylesVal,
  ...
  function curCSS(elem, name, computed) {
    ...
    if (computed) {
      ...
      if (!support.pixelBoxStyles() && rnumnonpx.test(ret) && rboxStyle.test(
          name)) {
...
// a vendor prefixed property.
  ...
  function boxModelAdjustment(elem, dimension, box, isBorderBox, styles,
      computedVal) {
    ...
    for (; i < 4; i += 2) {
      ...
      if (!isBorderBox) {
        ...
        if (box !== "padding") {
          delta += jQuery.css(elem, "border" + cssExpand[i] + "Width", true,
              styles);
    ...
    _default: {
      get: function (tween) {
        ...
        if (tween.elem.nodeType !== 1 ||
            tween.elem[tween.prop] != null && tween.elem.style[tween.prop]
            == null) {
  ...
  jQuery.fn.extend({
    ...
    position: function () {
      ...
      if (jQuery.css(elem, "position") === "fixed") {
        ...
        if (offsetParent && offsetParent !== elem && offsetParent.nodeType
            === 1) {
